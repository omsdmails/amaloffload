# your_tasks.py (مُحدَّث)
# ============================================================
# مجموعة مهام محسوبة يمكن أوفلودها تلقائياً إذا احتاج الجهاز
# ============================================================

from task_interceptor import offload_if_needed as offload  # ← الاستيراد الصحيح
import time
import math
import numpy as np
...
def matrix_multiply(size: int) -> Dict[str, List[List[float]]]:
    """ضرب مصفوفات كبيرة (عملية كثيفة الحساب).
